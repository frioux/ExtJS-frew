...
(function() {
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp: function() {
            this.items = [
                buildFakeChild({getWidth: function() {return 10;}}),
                buildFakeChild({getWidth: function() {return 20;}}),
                buildFakeChild({getWidth: function() {return 30;}}),
                buildFakeChild({getWidth: function() {return 40;}})
            ];
