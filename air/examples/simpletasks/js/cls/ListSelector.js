...
tx.form.ListSelector = Ext.extend(Ext.ux.TreeSelector, {
	maxHeight:200,
	listenForLoad: false,
	readOnly: false,
	editable: false,
    initComponent : function(){
		...
		this.tree = new Ext.tree.TreePanel({
			...
			loader : new tx.tree.ListLoader({store: this.store})		
		});
        ...
        tx.form.ListSelector.superclass.initComponent.call(this);
