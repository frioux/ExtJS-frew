...
Ext.extend(Ext.data.DataProxy, Ext.util.Observable, {
	/**
	 * @cfg {Object} api
	 * Specific urls to call on CRUD methods "load", "create", "save" and "destroy"
	 */
	api: {
		load : undefined,
		create : undefined,
	...
	/**
	 * doRequest
	 * Should be over-ridden in all extensions, eg: HttpProxy#doRequest, DirectProxy#doRequest
	 */
