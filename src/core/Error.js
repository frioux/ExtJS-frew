...
/**
 * <p>
 *  The Ext.ErrorMgr class is intended to be a simple solution for client-side
 ...
 *  and not relying on the browser.  In this case, call the <b><tt>handle</tt></b>
 *  method:
 * </p>
 * <pre>
 *  try {
 ...
 */
Ext.ErrorMgr = Ext.extend(Ext.util.Observable, (function() {
    return {
        /**
         * @private
         * @constructor
        ...
        constructor: function() {
            Ext.ErrorMgr.superclass.constructor.call(this);
            this.addEvents(
                /**
                 * Fires when an error has been handled.  This event is fired from the handle method.
                 * @event error
                 * @param {Object} error An object containing the following:
                 * <ul>
                 *  <li>raw : <b>Object</b><p class="sub-desc">the original arguments passed to handle</p></li>
        ...
        init: function () {
            ...
            window.onerror = !window.onerror ? Ext.ErrorMgr.handle : window.onerror.createSequence(Ext.ErrorMgr.handle);
            Ext.select("img").each(function(el, list, index) {
                el.on("error", Ext.ErrorMgr.handle);
            });
        },
        /**
        ...
        handle:  function () {
            ...
            if (args.length > 0) {
                ...
                //  arguments.callee               // the handle method
                //  arguments.callee.caller        // delegate for handle
...
Ext.ErrorMgr = new Ext.ErrorMgr();
// the following line ensures that the handle method always executes in the scope of ErrorHandler
Ext.ErrorMgr.handle = Ext.ErrorMgr.handle.createDelegate(Ext.ErrorMgr);
